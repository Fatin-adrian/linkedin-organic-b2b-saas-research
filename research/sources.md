...
Track up to **10 verified experts** who practice LinkedIn organic content strategy in a B2B SaaS context.

**Selection criteria (use before adding a row):**

- Active, recent organic LinkedIn content (not ads-only or dormant profiles)
- Clear B2B SaaS relevance (operator, founder, marketer, or advisor with SaaS focus)
...
## Discovery Log (optional)

Brief notes on where candidates were found (search terms, referrals, events). No fabricated links.

| Date | Channel / method | Candidates surfaced | Next action |
|------|------------------|---------------------|-------------|
| | | | |
